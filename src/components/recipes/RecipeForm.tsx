  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={editingRecipe ? 'Edit Recipe' : 'New Recipe'} fullscreen>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="sticky bottom-0 bg-white pt-3 pb-2 -mx-4 px-4 md:-mx-8 md:px-8 lg:-mx-10 lg:px-10 border-t border-border/40 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
