...
import { Heart, Calendar, Settings, Crown, Check, BookOpen } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-56 md:fixed md:top-14 md:bottom-0 md:left-0 bg-surface/95 backdrop-blur-sm border-r border-border">
      <nav className="flex-1 py-6 px-3 flex flex-col gap-1 justify-between">
        ...
        <div className="border-t border-border pt-3 mt-2">
          ...
          >
            <span className={`relative flex shrink-0 rounded-lg p-1.5 ${pathname.startsWith('/blog') ? 'bg-white/20' : 'bg-surface-dark/70'}`}>
