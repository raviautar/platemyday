    ...
    <div>
      ...
      <div className="flex gap-2 mb-6 border-b border-border">
        ...
        <button
          ...
          className={`px-4 py-2 font-medium transition-colors border-b-2 ${activeTab === 'general'
              ? 'border-primary text-primary'
              : 'border-transparent text-muted hover:text-foreground'
            }`}
        >
        ...
        {activeTab === 'general' && (
          <>
              ...
              <div className="grid grid-cols-7 gap-2">
                {WEEK_DAYS.map(day => (
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg border-2 transition-all text-xs font-medium flex items-center justify-center ${settings.weekStartDay === day
            ...
            <div className="bg-white rounded-xl border border-border p-4 space-y-4">
              ...
              <p className="text-sm text-muted">
                Choose your preferred unit system for recipes. This will automatically update generated recipes.
              </p>

              <div className="flex gap-3">
                <button
                  onClick={() => handleUnitSystemChange('metric')}
                  className={`flex-1 px-4 py-3 rounded-lg border-2 transition-all ${settings.unitSystem === 'metric'
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-3 rounded-lg border-2 transition-all ${settings.unitSystem === 'imperial'
                      ? 'border-primary bg-primary/5 text-primary font-medium'
                      : 'border-border bg-white text-muted hover:border-primary/50'
                    }`}
                >
