...
function SignUpForm() {
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    // If the user was created and a session exists (email confirmation disabled),
    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-white">
        ...
        <div className="relative z-10 w-full max-w-md mx-auto px-4 text-center">
          <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full flex items-center justify-center shadow-lg">
            <CheckCircle className="w-8 h-8 text-white" />
          </div>
          <h2 className="text-2xl font-bold font-[family-name:var(--font-outfit)] text-foreground mb-3">
            Check your email
          </h2>
